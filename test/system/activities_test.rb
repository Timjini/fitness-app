...
class ActivitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Activity" do
    ...
    fill_in "Created", with: @activity.created
    fill_in "Deleted at", with: @activity.deleted_at
    fill_in "Description", with: @activity.description
    fill_in "Finished", with: @activity.finished
    fill_in "State", with: @activity.state
